...
const contractAddress = "0xc417c3eb7bba3E0902951422E272949838f82D01"; //address of smart contract
            ...
            <Card>
              <CardContent>
                <Stack spacing={2}>
                  ...
                  <TextField label="PLS Balance" value={balance} />
                  <Divider />
                  <Typography>Buy PLS (1 ETH = 10 PLS)</Typography>
                  <TextField
                    label="ETH"
                    type="number"
